package com.oyatulloh.myfirstproject
...
class MainActivity : AppCompatActivity(), View.OnClickListener {
    ...
    private fun obyektYaratish() {
        ...
        flagArrayList.add(Flag("o'zbekiston", R.drawable.uzb))
        flagArrayList.add(Flag("rassiya", R.drawable.russian))
        flagArrayList.add(Flag("xitoy", R.drawable.china))
        flagArrayList.add(Flag("aqsh", R.drawable.aqsh))
        flagArrayList.add(Flag("qirg'ziston", R.drawable.kirgizstana))
        flagArrayList.add(Flag("turkmaniston", R.drawable.turkmaniston))
        flagArrayList.add(Flag("qozog'iston", R.drawable.qozogiston))
        flagArrayList.add(Flag("koreya", R.drawable.koreya))
        flagArrayList.add(Flag("hindiston", R.drawable.hindiston))
        flagArrayList.add(Flag("afrika", R.drawable.afrika))
        flagArrayList.add(Flag("iroq", R.drawable.iroq))
        flagArrayList.add(Flag("birazilya", R.drawable.brazilya))
        flagArrayList.add(Flag("", R.drawable.finish))
